 ...
 * we want out data to be partitioned only by join attribute, the custom
 * partitioner is implemented. One reducer receives all data with the same join
 * attribute.
 * 
